...
export const COMMUNIQUES = [
  {
    ...
    fr: {
      ...
      videoHeading1: 'Chamonix,',
      videoHeading2: 'face au Mont-Blanc',
      videoTagline:
        'Le passage face au massif, avant la bascule vers Vallorcine et la seconde moitié de course.',
      photoAlts: [
    ...
    en: {
      ...
      videoHeading1: 'Chamonix,',
      videoHeading2: 'facing Mont-Blanc',
      videoTagline:
        'The stretch facing the massif, before tipping over toward Vallorcine and the second half of the race.',
      photoAlts: [
