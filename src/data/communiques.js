...
export const COMMUNIQUES = [
  {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "Or le tracé concentre ses passages les plus exposés exactement là : l’Aiguillette des Posettes plein cagnard vers le 18ᵉ kilomètre, puis les singles cassants du col des Montets et la piste de ski de la Flégère en toute fin de parcours.",
