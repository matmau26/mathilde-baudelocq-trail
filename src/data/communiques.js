...
export const COMMUNIQUES = [
  {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "Le timing est cruel : ce moment tombe exactement sur la portion la plus technique du parcours. Les crêtes, où quatre kilomètres prennent une heure et demie, où les cailloux et les franchissements s'enchaînent. Un décor magnifique qu'elle ne regarde pas. La course devient un combat.",
        {
          ...
          body: "Au Pas de Pertuson, au 58ᵉ kilomètre, elle a cédé cinq places au féminin. C'est là que se pose la vraie question de la journée : est-ce que je continue ? Est-ce que ça vaut le coup ? Je n'étais pas venue pour ça.",
        },
    ...
    en: {
      ...
      paragraphs: [
        ...
        "From the inside, no. From the very first hours, the signals come: she has to blow her nose without stopping, and above all the trachea and lungs start to burn. As for doubt, it never really left her since Friday morning — it grows with every kilometre.",
        {
        ...
        "The timing is cruel: this moment lands exactly on the most technical part of the course. The ridges, where four kilometres take an hour and a half, where rocks and scrambles pile up. A stunning setting she doesn't look at. The race becomes a fight.",
        {
          ...
          body: "At Pas de Pertuson, at kilometre 58, she has ceded five places to the women. That's when the real question of the day rises: do I continue? Is it worth it? I didn't come for this.",
        },
        ...
        "She crosses the line in Villard-de-Lans in 14:30:03, after 84.9 kilometres and nearly 4,900 metres of positive elevation actually measured on the trace — beyond the 4,300 announced. 25th woman out of 55 finishers, 125th out of 247 ranked. The women's field median that day was 15:06: sick, she beats it by thirty-six minutes.",
