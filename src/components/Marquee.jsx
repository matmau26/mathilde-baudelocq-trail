...
export default function Marquee() {
  ...
  const items = [
    a.kpis?.[0]?.metric ? `${a.kpis[0].metric} ${a.kpis[0].value}${a.kpis[0].suffix}` : 'TOP 3%',
    'GR Ventoux 2026',
    'ITRA 565',
    'UTMB 568',
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-y border-mountain-950/10 bg-mountain-950 py-5"
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-mountain-950 to-transparent sm:w-24"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-mountain-950 to-transparent sm:w-24"
      />
    </section>
  );
}
