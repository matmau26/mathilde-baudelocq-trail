...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      tagCity: 'Montélimar (26)',
      tagProject: 'Projet 2026',
      tagStatus: 'Statut Élite',
      season: 'Saison 2026',
      traceLine1: 'Trajectoire',
      traceLine2: 'Élite',
      logoAlt: 'Logo Mathilde Baudelocq — Trail Athlete',
      portraitAlt: 'Mathilde Baudelocq, portrait au lac',
      snapshot: 'Snapshot',
    ...
    communiques: {
      ...
      nextEyebrow: 'Et après ?',
      nextTitle1: 'Discutons d’un projet',
      nextTitle2: 'sur la durée.',
      nextCta: 'Prendre contact',
      labels: {
        location: 'Lieu',
        distance: 'Distance',
        elevation: 'Dénivelé',
  ...
  en: {
    ...
    hero: {
      ...
      tagCity: 'Montélimar (26)',
      tagProject: '2026 Project',
      tagStatus: 'Elite Status',
      season: '2026 Season',
      traceLine1: 'Elite',
      traceLine2: 'Trajectory',
      logoAlt: 'Mathilde Baudelocq — Trail Athlete logo',
      portraitAlt: 'Mathilde Baudelocq, lakeside portrait',
      snapshot: 'Snapshot',
      snapshotPeriod: '2025–26',
      grvBadge: 'Top 3%',
    ...
    communiques: {
      ...
      nextTitle1: 'Let’s discuss a project',
      nextTitle2: 'for the long run.',
